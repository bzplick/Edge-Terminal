...
- Each ticker card should show: ticker, price, % change, volume / relative volume, scanner bucket, conviction score, risk score, dilution warning, entry / stop / target zones, VWAP status, RSI/MACD status, and a plain-English explanation.
...
Return scores from 0–100 with reasons.
...
## UI Style
Dark mode, clean trading-terminal feel, readable on iPhone. Use large cards, clear green/red risk labels, and avoid clutter.

## Important
This is not financial advice. Add a small disclaimer in the UI footer. Do not place real trades. This is scanner/watchlist software only.
